            ...
            <ul class="right">
              ...
              <li class="has-dropdown"><a href="/adoptable-dogs/">Adopt</a>
                <ul class="dropdown">
                  ...
                  <li><a class="external-link" href="https://docs.google.com/forms/d/e/1FAIpQLSeWT2ExXhpCpz-K5fELnkeUzhv5jFynlBzkv3eXl7bRnoFjVw/viewform" target="_blank">Adoption Application<i class="fa fa-external-link" aria-hidden="true"></i></a></li>
                  <li><a class="external-link active" href="https://docs.google.com/forms/d/e/1FAIpQLSeWT2ExXhpCpz-K5fELnkeUzhv5jFynlBzkv3eXl7bRnoFjVw/viewform" target="_blank">Fostering Application<i class="fa fa-external-link" aria-hidden="true"></i></a></li>
                </ul>
              </li>
