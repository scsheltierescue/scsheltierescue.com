...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.20191118.png"> <!-- Cache Busting -->
    <link rel="icon" type="image/png" href="/favicon-192x192.20191118.png" sizes="192x192"> <!-- Cache Busting -->
    <link rel="icon" type="image/png" href="/favicon-32x32.20191118.png" sizes="32x32"> <!-- Cache Busting -->
    <link rel="icon" type="image/png" href="/favicon-16x16.20191118.png" sizes="16x16"> <!-- Cache Busting -->
    <link rel="manifest" href="/manifest.json">
    <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#5bbad5">
    <meta name="theme-color" content="#ffffff">

    <link rel="stylesheet" href="/css/app.20191118.css"> <!-- Cache Busting -->
    <script src="/js/vendor/modernizr.20191118.js"></script> <!-- Cache Busting -->
  </head>
  <body>
    <!--[if lte IE 8]>
      ...
      <div class="contain-to-grid sticky">
        <nav class="top-bar" data-topbar>
          ...
          <section class="top-bar-section">
            <ul class="right">
              <li><a href="/">Home</a></li>
              <li class="has-dropdown"><a href="/adoption-requirements/">Adopt</a>
                <ul class="dropdown">
                  <li><a href="/adoption-requirements/">Adoption Requirements</a></li>
                  <li><a href="http://www.petfinder.com/pet-search?shelterid=SC92" target="_blank" class="external-link">Adoptable Dogs <i class="fa fa-external-link" aria-hidden="true"></i></a></li>
    ...
    <script src="/bower_components/jquery/dist/jquery.min.20191118.js"></script> <!-- Cache Busting -->
    <script src="/bower_components/handlebars/handlebars.runtime.min.20191118.js"></script> <!-- Cache Busting -->
    <script src="/js/plugins.20191118.js"></script> <!-- Cache Busting -->
    <script src="/js/templates.20191118.js"></script> <!-- Cache Busting -->
    <script src="/bower_components/foundation/js/foundation.min.20191118.js"></script> <!-- Cache Busting -->
    <script src="/js/apply-form.20191118.js"></script> <!-- Cache Busting -->
