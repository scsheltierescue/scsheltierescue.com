...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.20181020.png"> <!-- Cache Busting -->
    <link rel="icon" type="image/png" href="/favicon-192x192.20181020.png" sizes="192x192"> <!-- Cache Busting -->
    <link rel="icon" type="image/png" href="/favicon-32x32.20181020.png" sizes="32x32"> <!-- Cache Busting -->
    <link rel="icon" type="image/png" href="/favicon-16x16.20181020.png" sizes="16x16"> <!-- Cache Busting -->
    <link rel="manifest" href="/manifest.json">
    <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#5bbad5">
    <meta name="theme-color" content="#ffffff">

    <link rel="stylesheet" href="/css/app.20181020.css"> <!-- Cache Busting -->
    <script src="/js/vendor/modernizr.20181020.js"></script> <!-- Cache Busting -->
  </head>
  <body>
    <!--[if lte IE 8]>
    ...
    <script src="/bower_components/jquery/dist/jquery.min.20181020.js"></script> <!-- Cache Busting -->
    <script src="/bower_components/handlebars/handlebars.runtime.min.20181020.js"></script> <!-- Cache Busting -->
    <script src="/js/plugins.20181020.js"></script> <!-- Cache Busting -->
    <script src="/js/templates.20181020.js"></script> <!-- Cache Busting -->
    <script src="/bower_components/foundation/js/foundation.min.20181020.js"></script> <!-- Cache Busting -->
    <script src="/js/apply-form.20181020.js"></script> <!-- Cache Busting -->
